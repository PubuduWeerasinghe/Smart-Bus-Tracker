...
<nav class="w3-sidebar w3-bar-block   w3-teal w3-small w3-hide-small w3-center">
  ...
  <a href="#admin" class="w3-bar-item w3-button w3-padding-large w3-hover-dark-grey">
    ...
    <table class="w3-table" >
        ...
        <tr>
          ...
          <div class="w3-container w3-large w3-round-xlarge">                  
                  ...
                  <input class="form-control " name="to" id="ex1" placeholder="Type Destination Place" required>
               </div>
             </div>   
        </tr>
          <tr>
...
<table>
  ...
  <header class="w3-display-container w3-padding-64 w3-center w3-grey " style="height:800px;" id="contact">
...
<div class="w3-container w3-padding-64" id="main">
    <header class="w3-display-container w3-padding-64 w3-center w3-grey" style="height:650px"; id="admin"> 
...
$query="SELECT * FROM `login` WHERE `UserName`='Pubudu' && `Password`=12345";
 ...
 <form action="B.php#available"  method="POST">
    ...
    <tr> 
      <div class="w3-container w3-large w3-round-xlarge">         
          ...
          <td>  
            <div class="w3-container ">          
          <button type="submit" class="w3-button w3-teal w3-padding-large w3-round-xlarge btn-block" name="sub" role="button"><i class="fa fa-bus" style="font-size:20px"></i>  Submit</button>       
          </div>        
          </td>          
        </tr>
